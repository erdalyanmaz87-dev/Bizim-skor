(function(root,factory){
  ...
  function enhanceBoard(board,playerName){
    ...
    if(!shouldShowButton(playerName,row)){removeToolbar(board);return false}
    ...
    toolbar.appendChild(button);board.insertAdjacentElement('beforebegin',toolbar);
    return true;
  }
  ...
  function ensureStyles(){
    ...
    style.textContent='.bs-find-me-toolbar{display:flex;justify-content:flex-end;margin:8px 0}.bs-find-me-button{border:0;border-radius:999px;background:#2563eb;color:#fff;padding:9px 14px;font-size:12px;font-weight:900;box-shadow:0 4px 10px rgba(37,99,235,.24)}.bs-find-me-button:active{transform:translateY(1px)}tr.bs-my-ranking-row>td{background:#dbeafe!important;box-shadow:inset 0 2px #2563eb,inset 0 -2px #2563eb;transition:background .2s ease}tr.bs-my-ranking-row>td:first-child{box-shadow:inset 2px 0 #2563eb,inset 0 2px #2563eb,inset 0 -2px #2563eb}tr.bs-my-ranking-row>td:last-child{box-shadow:inset -2px 0 #2563eb,inset 0 2px #2563eb,inset 0 -2px #2563eb}';
