(function(root,factory){
  ...
  function ensureHomeAction(header){
    ...
    document.getElementById('bsHeaderHomeAction')?.addEventListener('click',()=>document.querySelector('[data-tab="home"]:not(#bsHeaderHomeAction)')?.click());
  }
  function refresh(){
    ...
    action.addEventListener('click',()=>{
      ...
      document.querySelector('[data-tab="home"]:not(#bsHeaderHomeAction)')?.click();
  ...
  return Object.freeze({headerAccountState,buildHeaderMarkup,homeActionMarkup,refresh,mount});
});
