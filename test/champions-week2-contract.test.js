...
test('loaded Champions UI handles opportunity fixture scoring',()=>{
  const champions=read('champions-league-ui.js');
  assert.match(champions,/CHAMPIONS_OPPORTUNITY_ID=33/);
  assert.match(champions,/scoreChampionsPrediction/);
  assert.match(champions,/Fırsat Maçı/);
});
