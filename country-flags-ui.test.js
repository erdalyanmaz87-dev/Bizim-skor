...
assert.equal(flags.flagForCountry('Galler'),'🏴󠁧󠁢󠁷󠁬󠁳󠁿');
assert.equal(flags.flagForCountry('İngiltere'),'🏴󠁧󠁢󠁥󠁮󠁧󠁿');
...
assert.equal(flags.decoratePlainText('Galler - İngiltere'),'🏴󠁧󠁢󠁷󠁬󠁳󠁿 Galler - 🏴󠁧󠁢󠁥󠁮󠁧󠁿 İngiltere');
