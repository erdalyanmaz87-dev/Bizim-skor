...
test('football is a dynamic sphere shot toward free-aim point',()=>{assert.match(src,/footballBody/);assert.match(src,/applyImpulse/);assert.match(src,/shootAtClientPoint/);});
