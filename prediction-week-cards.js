(function(root,factory){
  ...
  function openCard(card){
    ...
    const clTab=document.querySelector('[data-tab="championsLeague"], [data-tab="champions"], #championsLeagueTab');
    clTab?.click();
  }
  ...
  return Object.freeze({buildCards,canEditBeforeWeekStart,render,openCard,mount,refresh});
});
