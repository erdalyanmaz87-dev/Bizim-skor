...
test('normal maçta tam skor 4, doğru sonuç 1 puan gösterir',()=>{
  assert.deepEqual(Daily.predictionStatus({home:2,away:1},{home:2,away:1},false),{kind:'exact',points:4,label:'🎯 Skor şu an tutuyor • Anlık 4 puan'});
  assert.deepEqual(Daily.predictionStatus({home:1,away:0},{home:2,away:1},false),{kind:'result',points:1,label:'✅ Sonuç şu an tutuyor • Anlık 1 puan'});
});
