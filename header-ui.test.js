...
assert.strictEqual(typeof ui.museumActionMarkup,'function');
assert.ok(ui.museumActionMarkup('Erdal').includes('🏛️ Müze'));
assert.ok(ui.museumActionMarkup('Erdal').includes('data-player-museum-open="Erdal"'));
...
assert.ok(styles.includes('.bs-header-primary-actions'));
