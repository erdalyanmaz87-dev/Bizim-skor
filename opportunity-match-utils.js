(function(root,factory){const api=factory();if(typeof module==='object'&&module.exports)module.exports=api;else root.BizimSkorOpportunity=api;})(typeof globalThis!=='undefined'?globalThis:this,function(){
  const SUPER_FIXTURE_ID=44,SUPER_WEEK=5,CHAMPIONS_FIXTURE_ID=3,CHAMPIONS_WEEK=1,NATIONS_WEEK1_FIXTURE_ID=9006,NATIONS_WEEK2_FIXTURE_ID=9014;
  ...
  function isSuperOpportunity(value){const id=fixtureId(value),week=fixtureWeek(value);return id===SUPER_FIXTURE_ID&&(week==null||week===SUPER_WEEK)}
  ...
  return{SUPER_FIXTURE_ID,SUPER_WEEK,CHAMPIONS_FIXTURE_ID,CHAMPIONS_WEEK,NATIONS_WEEK1_FIXTURE_ID,NATIONS_WEEK2_FIXTURE_ID,isSuperOpportunity,isChampionsOpportunity,isNationsOpportunity,isOpportunityFixture:isSuperOpportunity,pointsForSuper,pointsForChampions,pointsForNations,pointsFor};
});
