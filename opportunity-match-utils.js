(function(root,factory){const api=factory();if(typeof module==='object'&&module.exports)module.exports=api;else root.BizimSkorOpportunity=api;})(typeof globalThis!=='undefined'?globalThis:this,function(){
  const SUPER_FIXTURES=[{id:44,week:5},{id:49,week:6},{id:58,week:7}],CHAMPIONS_FIXTURE_ID=33,CHAMPIONS_WEEK=2,NATIONS_WEEK1_FIXTURE_ID=9006,NATIONS_WEEK2_FIXTURE_ID=9014;
  const SUPER_FIXTURE_ID=58,SUPER_WEEK=7;
