...
assert.strictEqual(loader.assetUrl('brand-assets.js'),'brand-assets.js?v=20260925-mobile-startup-v1');
assert.strictEqual(loader.assetUrl('country-flags-ui.js'),'country-flags-ui.js?v=20260925-mobile-startup-v1');
assert.strictEqual(loader.assetUrl('ranking-table-alignment.css'),'ranking-table-alignment.css?v=20260925-mobile-startup-v1');
