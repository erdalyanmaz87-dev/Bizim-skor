(function(root,factory){
  ...
  function baseStyles(){return '.football-center-pills{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin:10px 0}.football-center-categories{display:grid;grid-template-columns:repeat(3,1fr);gap:8px;margin:12px 0}.football-center-pills button,.football-center-categories button{background:#e2e8f0;color:#334155}.football-center-pills button.active,.football-center-categories button.active{background:#0f172a;color:#fff}.football-center-table-wrap{width:100%;overflow-x:hidden}.football-center-table-wrap table{width:100%;min-width:0;table-layout:fixed}.football-center-table-wrap th,.football-center-table-wrap td{overflow-wrap:anywhere}.football-center-table-wrap th:first-child,.football-center-table-wrap td:first-child{width:42px}.football-center-table-wrap th:last-child,.football-center-table-wrap td:last-child{width:42px}.football-center-standings th:nth-child(2),.football-center-standings td:nth-child(2){white-space:nowrap;overflow-wrap:normal;word-break:normal}.football-center-standings th:nth-child(3),.football-center-standings td:nth-child(3){width:32px}.football-center-standings th:nth-child(4),.football-center-standings td:nth-child(4){width:42px}.football-center-updated,.football-center-empty,.football-center-error{font-size:12px;color:#64748b}.football-center-error{padding:12px;border-radius:10px;background:#fee2e2;color:#991b1b}@media(max-width:430px){.football-center-categories{grid-template-columns:1fr}.football-center-table-wrap th,.football-center-table-wrap td{padding:8px 4px;font-size:13px}.football-center-table-wrap th:first-child,.football-center-table-wrap td:first-child{width:36px}.football-center-table-wrap th:last-child,.football-center-table-wrap td:last-child{width:36px}}'}

  function ensureStyles(){
    if(!document.getElementById('footballCenterBaseStyles')){
      const style=document.createElement('style');style.id='footballCenterBaseStyles';style.textContent=baseStyles();document.head.appendChild(style);
    }
  ...
  return{tabMarkup,sectionMarkup,themeClass,baseStyles,start,mount};
});
