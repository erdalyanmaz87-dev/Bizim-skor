(function(root,factory){
  ...
  function ensureStyles(){
    if(!document.getElementById('footballCenterBaseStyles')){
      const style=document.createElement('style');style.id='footballCenterBaseStyles';style.textContent='.football-center-pills{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin:10px 0}.football-center-categories{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin:12px 0}.football-center-pills button,.football-center-categories button{background:#e2e8f0;color:#334155}.football-center-pills button.active,.football-center-categories button.active{background:#0f172a;color:#fff}.football-center-table-wrap{overflow-x:auto}.football-center-table-wrap table{min-width:440px}.football-player-card{display:grid;grid-template-columns:1fr auto;gap:4px 10px;padding:10px 0;border-bottom:1px solid #e5e7eb}.football-player-card span{color:#64748b;font-size:12px}.football-player-card em{grid-column:2;grid-row:1/3;align-self:center;color:#b45309;font-style:normal;font-weight:700}.football-center-updated,.football-center-empty,.football-center-error{font-size:12px;color:#64748b}.football-center-error{padding:12px;border-radius:10px;background:#fee2e2;color:#991b1b}@media(max-width:430px){.football-center-categories{grid-template-columns:1fr}}';document.head.appendChild(style);
    }
